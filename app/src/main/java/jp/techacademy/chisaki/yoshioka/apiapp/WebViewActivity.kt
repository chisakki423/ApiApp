...
class WebViewActivity: AppCompatActivity(),WebFragmentCallback {
    ...
    private fun deleteFavorite(id: String) {
      ...
      //  (viewPagerAdapter.fragments[WebViewActivity.VIEW_PAGER_POSITION_API] as ApiFragment).updateView()
      //  (viewPagerAdapter.fragments[WebViewActivity.VIEW_PAGER_POSITION_FAVORITE] as FavoriteFragment).updateData()
    }
}